...
reconDir = '/Users/cag/Documents/Dataset/recon_results/250822/';

mask_note_list={'idea_libre','ps_swap_0', ...
    'ps_swap_1', 'idea_libre_t2w', 'ps_t2w_hs', 'idea_t2w_smallsize'};

mask_note = mask_note_list{subject_num};

if subject_num == 1
    meas_name_suffix = '_MID00157_FID314156_JB_LIBRE2p2_a8_woPERewinder';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
...
elseif subject_num == 4
    meas_name_suffix = '_MID00160_FID314159_JB_t2w_LIBRE2p2_a8_woPERewinder';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=419;
elseif subject_num == 5
    meas_name_suffix = '_MID00184_FID314183_t2_22_hs';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=419;

elseif subject_num == 6
    meas_name_suffix = '_MID00176_FID314175_JB_LIBRE2p2_t2w';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=419;
end
...
p.FoV = 480;  % Field of View YJ tried
%
