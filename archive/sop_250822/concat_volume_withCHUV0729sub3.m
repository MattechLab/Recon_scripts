...
x1_trans = norm_image(permute(x1, [2,1,3]));
x1_sag = norm_image(flip(rot90(permute(x1_trans, [1,3,2]), 1),1));
x1_coronal = norm_image(permute(x1_trans, [3,2,1]));
bmImage(x1_coronal);

x2_trans = norm_image(flip(permute(x2, [2,1,3]),1));
x2_sag = norm_image(rot90(permute(x2_trans, [1,3,2]),1));
x2_coronal = norm_image(flip(permute(x2_trans, [3,2,1]),1));
bmImage(x2_coronal);

x3_trans = norm_image(rot90(permute(x3, [2,1,3]),1));
x3_sag = norm_image(flip(rot90(permute(x3_trans, [1,3,2]), 1),1));
x3_coronal = norm_image(permute(x3_trans, [3,2,1]));
bmImage(x3_coronal);
%%
x4_trans = norm_image(rot90(permute(x_chuv, [2,1,3]),1));
%
x4_sag = norm_image(rot90(permute(x4_trans, [1,3,2]), 1));
