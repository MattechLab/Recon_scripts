...
% ==========================================
%% Load SNRs
datadir   = '/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/sub2_jb/masks/';   % adapt as needed
firstIdx  = 115;                               % first slice number
lastIdx   = 119;                              % last  slice number
...
fprintf('Mean CNR (site 1 IDEA): %.2f\n', mean_cnr1);
fprintf('Mean CNR (site 1 pulseq): %.2f\n', mean_cnr2);
fprintf('Mean CNR (site 2 pulseq): %.2f\n', mean(mean_cnr3));  % prints grand mean
...
exportgraphics(fig, '/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/sub2_jb/masks/SNR_trend_vial.pdf', 'ContentType','vector');
...
patch([vials, fliplr(vials)], [min_cnr2, fliplr(max_cnr2)], face4, ...
      'EdgeColor','none','FaceAlpha',0.25, 'Parent',ax);
patch([vials, fliplr(vials)], [min_cnr3, fliplr(max_cnr3)], face4, ...
      'EdgeColor','none','FaceAlpha',0.25, 'Parent',ax);
...
% ── 7.  Export vector graphic ──
exportgraphics(fig, '/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/sub2_jb/masks/CNR_trend_vial.pdf', 'ContentType','vector');
...
exportgraphics(fig, ['/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/' ...
    'sub2_jb/masks/corre_snr_cnr_multi_vendor.pdf'], 'ContentType','vector');
...
for k = 1:2
    ...
    [yfit,ci] = predict(mdl,xfit,'Alpha',errorCI);   % 95 % CI
...
% ── 7.  Export vector graphic ──
exportgraphics(fig, ['/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/' ...
    'sub2_jb/masks/corre_snr_cnr_multi_site.pdf'], 'ContentType','vector');