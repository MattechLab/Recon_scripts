...
%%
    imgSlice_idea_t = equal_func(imgSlice_idea, 0, 0.35);
    imgSlice_pulseq_t = equal_func(imgSlice_pulseq, 0, 0.7);
    imgSlice_site_t = equal_func(imgSlice_site, 0, 0.60);
    ...
    switch mask_mode
        case 'trans' 
            ...
            sliceView_2 = flip(imgSlice_site_t,1);
        case 'coro'
            sliceIdxRange = 50:60;
...
%% SSIM
        crop1 = sliceView(60:180,1:120,85:105 );crop2 = sliceView_1(60:180,1:120,85:105);
        ...
        %%
        crop1 = sliceView_2(70:180,20:85,85:105 );crop2 = sliceView_1(70:180,20:85,85:105 );
        bmImage(cat(2, crop1, crop2));
...
%
maskFolder = '/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/sub3_yj/masks/';
...
%%
check_overlay_mask_img(maskROI_chuv_trans2cc2_sl116, sliceView_2(:,:,116));
%%
close all; 
checkOverlay=0;
maskROI = NaN;
...
snrPath = ['/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/sub3_yj/masks/', filename];
