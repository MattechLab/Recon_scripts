...
mask_note_list={'FA4_RF1_rfmod1_traj0Orig_PhNeg','FA4_RF2_rfmod2_traj0Orig_PhNeg', ...
    'FA4_RF2_rfmod2_traj0Orig_PhPos', 'FA4_RF1_rfmod1_traj0Orig_PhPos', 'idea'};

mask_note = mask_note_list{subject_num};

if subject_num == 1
    meas_name_suffix = '_MID00176_FID317802_yj_seq1';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
    seqName = "yj_seq1_t1w_libre_part_TR6.2ms_TE3.6ms_swap1_FA4_RF1_rfmod1_traj0Orig_PhNeg.seq";
...
elseif subject_num == 3
    meas_name_suffix = '_MID00178_FID317804_yj_seq3';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
    seqName = "yj_seq3_t1w_libre_part_TR6.2ms_TE3.6ms_swap1_FA4_RF2_rfmod2_traj0Orig_PhPos.seq";

elseif subject_num == 4
    meas_name_suffix = '_MID00179_FID317805_yj_seq4';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
    seqName = "yj_seq4_t1w_libre_part_TR6.2ms_TE3.6ms_swap1_FA4_RF1_rfmod1_traj0Orig_PhPos.seq";
elseif subject_num == 5
    meas_name_suffix = '_MID00182_FID317808_JB_LIBRE2p2_a8_woPERewinder';
     hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
end
