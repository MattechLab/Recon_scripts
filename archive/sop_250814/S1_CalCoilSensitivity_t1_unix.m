...
% meas_MID00174_FID312409_JB_main_LIBRE2p2_a8_woPERewind.dat
% meas_MID00175_FID312410_JB_HC_LIBRE2p2_a8_woPERewind.dat
% meas_MID00177_FID312412_JB_BC_LIBRE2p2_a8_woPERewind.dat
% meas_MID00178_FID312413_yj_bc_s3.dat
% meas_MID00180_FID312415_yj_s4.dat
% meas_MID00181_FID312416_yj_s3_main.dat
% meas_MID00182_FID312417_yj_s5.dat
% meas_MID00183_FID312418_yj_s6.dat
% meas_MID00184_FID312419_JB_T2LIBRE2p2_a8_woPERewinder.dat
...
use_C = 0;
%
datasetDir = '/Users/cag/Documents/Dataset/datasets/250814/';
reconDir = '/Users/cag/Documents/Dataset/recon_results/250814/';

mask_note_list={'idea_libre','idea_t2w_libre', ...
    's3_libre_rfmod1', 's4_libre_rfmod3', ...
    's5_libre_rfmod1_te3p9', 's6_libre_rfmod3_te3p9'
...
if subject_num == 1
    meas_name_suffix = '_MID00174_FID312409_JB_main_LIBRE2p2_a8_woPERewind';
    hc_name_suffix = '_MID00175_FID312410_JB_HC_LIBRE2p2_a8_woPERewind';
    bc_name_suffix = '_MID00177_FID312412_JB_BC_LIBRE2p2_a8_woPERewind';
    nShot=1000;
elseif subject_num == 2
    meas_name_suffix = '_MID00184_FID312419_JB_T2LIBRE2p2_a8_woPERewinder';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=102;

elseif subject_num == 3
    meas_name_suffix = '_MID00181_FID312416_yj_s3_main';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;

elseif subject_num == 4
    meas_name_suffix = '_MID00180_FID312415_yj_s4';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
elseif subject_num == 5
    meas_name_suffix = '_MID00182_FID312417_yj_s5';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
elseif subject_num == 6
    meas_name_suffix = '_MID00183_FID312418_yj_s6';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot=1000;
end
