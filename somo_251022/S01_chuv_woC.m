...
seqName_list = { 'yj_seq3_t1w_libre_main_TR6.2ms_TE3.6ms_swap1_FA6_RF2_mreye_track_trajPTP.seq', ...  
    'yj0_seq8_t1w_libre_pre_TR6.2ms_TE3.6ms_swap1_FA4_RF2_rfmod2_trajPTP_PhNeg.seq'};

seqName = seqName_list{datatype};

if subject_num == 1
meas_name_list = {'meas_MID00408_FID04433_YJ_head.dat', ...
                                ' .dat'};
hc_name_list = {'meas_MID00412_FID04437_YJ_head_hc.dat', ...
                                    ' .dat'};
bc_name_list = {'meas_MID00419_FID04444_YJ_head_bc.dat', ...
                                    ' .dat'}; 
nShot_list = {1597};
nSeg_list = {44};
...
load('/Users/cag/Documents/Dataset/recon_results/251022/sub1_hemo/T1_LIBRE_woBinning/C/mask_noBin/C.mat')
