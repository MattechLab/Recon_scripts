...
datasetDir = '/Users/cag/Documents/Dataset/datasets/workshop/';
reconDir = '/Users/cag/Documents/Dataset/recon_results/workshop/';
seqFolder = "/Users/cag/Documents/Dataset/datasets/workshop/";
mask_note_list={'t2_hard','t2_hs', 't2_idea', ...
    't2prep_80ms', 'rew_tr8ms', 'norew_tr7p2ms', 'rew_tr7p2ms'};

mask_note = mask_note_list{subject_num};

if subject_num == 1
    meas_name_suffix = '_MID00051_FID319200_yj_seq1';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot = 233;
    nSeg = 88;
    seqName = "yj_seq1_t2w_libre_part_TR6.2ms_TE3.6ms_swap1_FA4_RF2_hard_Seg88Shot233.seq";

elseif subject_num == 2
    meas_name_suffix = '_MID00052_FID319201_yj_seq2';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot = 233;
    nSeg = 88;
    seqName = "yj_seq2_t2w_libre_part_TR6.2ms_TE3.6ms_swap1_FA4_RF2_hs_Seg88Shot233.seq";

elseif subject_num == 3
    meas_name_suffix = '_MID00054_FID319203_t2w_JB_LIBRE2p2_a8_woPERewinder';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot = 233;
    nSeg = 88;
...
elseif subject_num == 4
    meas_name_suffix = '_MID00182_FID319386_t2prep80';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot = 233;
    nSeg = 88;
    seqName = "yj_seq5_t2w_libre_part_TR6.2ms_TE3.6ms_swap1_FA4_RF2_hs_Seg88Shot233_80ms.seq";

elseif subject_num == 5
    meas_name_suffix = '_MID00193_FID319397_t1w_rew_TR8ms';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot = 987;
    nSeg = 22;
    seqName = "yj_seq6_t1w_libre_part_TR8.0ms_TE3.6ms_swap1_FA4_RF2_rfmod2_trajOrig_PhNeg_rewinder.seq";

elseif subject_num == 6
    meas_name_suffix = '_MID00194_FID319398_t1w_norew_TR7p2ms';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot = 987;
    nSeg = 22;
    seqName = "yj_seq4_t1w_libre_part_TR7.2ms_TE3.6ms_swap1_FA4_RF2_rfmod2_trajOrig_PhNeg.seq";
     

elseif subject_num == 7
    meas_name_suffix = '_MID00195_FID319399_t1w_rew_TR7p2ms';
    hc_name_suffix = ' ';
    bc_name_suffix = ' ';
    nShot = 987;
    nSeg = 22;
    seqName = "yj_seq3_t1w_libre_part_TR7.2ms_TE3.6ms_swap1_FA4_RF2_rfmod2_trajOrig_PhNeg_rewinder.seq";
