...
bern = 1; chuv=0;
    ...
    imgSlice_site =flip(normImage(x_c_set_back{subject_num,2}.img),1);
...
%%
    imgSlice_idea_t = equal_func(imgSlice_idea, 0, 0.5);
    imgSlice_pulseq_t = equal_func(imgSlice_pulseq, 0, 0.6);
    imgSlice_site_t = equal_func(imgSlice_site, 0, 0.50);
...
%% SSIM
        crop1 = sliceView(60:180,1:120,100:120 );crop2 = sliceView_1(60:180,1:120,100:120);
        bmImage(cat(2, crop1, crop2));
        %
        ssimValue = computeSSIMPerVol(crop1, crop2)
        %%
        crop1 = sliceView(60:180,1:60,100:120 );crop2 = sliceView_1(60:180,1:60,100:120);
        bmImage(cat(2, crop1, crop2));
        ...
        %%
        crop1 = sliceView_2(60:180,1:60,100:120 );crop2 = sliceView_1(60:180,1:60,100:120);
        bmImage(cat(2, crop1, crop2));
...
[bg_values, maskBg] = select_ROI(sliceView_2(:,:,115), 'rect');
...
for sliceIdx = sliceIdxRange
    ...
    fprintf('\n processing slice: %d\n', sliceIdx);
    for cc = 1:6 % set the phantom circle index
        ...
        SelectBack=0;
        if strcmp(dataset_label,'chuv')
            cal_roi_mask(sliceView_2(:,:,sliceIdx), roiShape, SelectBack, CalSNR, note_suffix);
        else
            cal_roi_mask(sliceView_1(:,:,sliceIdx), roiShape, SelectBack, CalSNR, note_suffix);
        end
    end
...
%
maskFolder = '/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/sub2_jb/masks/';
...
%%
check_overlay_mask_img(masks{5,1}, sliceView(:,:,116));
...
snrPath = ['/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/sub2_jb/masks/', filename];
