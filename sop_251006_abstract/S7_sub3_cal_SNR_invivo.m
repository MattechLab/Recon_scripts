...
% ==========================================
%% Load SNRs
datadir   = '/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/sub3_yj/masks/';   % adapt as needed
firstIdx  = 91;                               % first slice number
lastIdx   = 95;                              % last  slice number
...
cnr1_all = abs( snr1_all - snr1_all(:,iFat) );   % 
cnr2_all = abs( snr2_all - snr2_all(:,iFat) );   % 
cnr3_all = abs( snr3_all - snr3_all(:, iFat) );   %
cnr1_all(:,2) = [];
cnr2_all(:,2) = [];
cnr3_all(:,2) = [];
...
% % block-1  → SNR
lg = legend(ax,[l1 l2 l3],{'IDEA Bern SNR','Pulseq Bern SNR', 'Pulseq CHUV SNR'},...
...
exportgraphics(fig, '/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/sub3_yj/masks/SNR_trend_vial.pdf', 'ContentType','vector');
...
% ── 7.  Export vector graphic ──
exportgraphics(fig, '/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/sub3_yj/masks/CNR_trend_vial.pdf', 'ContentType','vector');
...
% create mask to exclude the noise outside the phantom
    ...
    switch mask_mode
        case 'trans' 
            ...
            x_pq_chuv = flip(permute(norm_image(x_pq_chuv),[2,1,3]),2);
        ...
        case 'coro'
            ...
            sliceView_2 = flip(flip(permute(imgSlice_site_t, [3,1,2]),1),2);
        ...
        case 'sag'
            ...
            sliceView_2 = flip(flip(permute(imgSlice_site_t, [3,2,1]),1),3);
...
exportgraphics(fig, ['/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/' ...
    'sub3_yj/masks/corre_snr_cnr_multi_vendor.pdf'], 'ContentType','vector');
...
% ── 7.  Export vector graphic ──
exportgraphics(fig, ['/Users/cag/Documents/Dataset/recon_results/251006_bern_abs/' ...
    'sub3_yj/masks/corre_snr_cnr_multi_site.pdf'], 'ContentType','vector');